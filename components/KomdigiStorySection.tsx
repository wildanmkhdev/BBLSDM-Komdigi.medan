          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <h3 className="text-xl font-bold text-[#0b1b3d] leading-snug">
                Penandatanganan Komitmen Akselerasi Talenta Digital di BBLSDM Komdigi Medan
              </h3>

              <p className="text-sm text-slate-500 leading-relaxed">
                Momen Wakil Menteri Komunikasi dan Digital (Wamenkomdigi) Nezar Patria menandatangani prasasti komitmen kunjungan kerja di BBLSDM Komdigi Medan. Kunjungan ini menandai penguatan sinergi pengembangan SDM digital berkualitas di wilayah Sumatera Utara dan 8 provinsi wilayah kerja balai.
              </p>
            </div>
            ...
            <div className="pt-4">
              ...
              >
                <span>Lihat Dokumentasi Kunker</span>
          ...
          <div className="lg:col-span-7 space-y-3">
            <div className="bg-slate-50 p-4 sm:p-6 rounded-2xl border border-slate-100 relative group">
              ...
              <div className="relative aspect-[4/3] w-full rounded-xl overflow-hidden shadow-sm">
                <Image
                  src="/kunker-nezar/kunker-nezar-2.jpeg"
                  alt="Wamenkomdigi Nezar Patria saat berdialog dengan para pegawai Kantor Balai Besar Pelatihan Sumber Daya Manusia Komunikasi dan Digital (BBLSDM Komdigi) Medan di Tembung"
                  fill
                ...
                <a
                  href="/kunker-nezar/kunker-nezar-2.jpeg"
                  download="kunker-nezar-2.jpeg"
