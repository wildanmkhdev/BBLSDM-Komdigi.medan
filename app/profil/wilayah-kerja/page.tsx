      ...
      <main className="flex-grow">
        ...
        <section className="bg-slate-50 border-b border-slate-100 py-14">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 pb-10 border-b border-slate-200">
              <div className="space-y-2">
                <p className="text-[11px] font-bold tracking-[0.2em] text-[#0284c7] uppercase">Profil Lembaga</p>
                <h1 className="text-3xl sm:text-4xl font-black text-[#0b1b3d] leading-tight">Wilayah Kerja</h1>
                <p className="text-sm text-slate-500 max-w-md leading-relaxed">
                  BBLSDM Komdigi Medan mencakup <strong>10 provinsi</strong> di Sumatera — klik marker atau nama provinsi untuk detail.
                </p>
              </div>
              {/* Stats */}
              <div className="flex items-center gap-6 flex-shrink-0">
                <div className="text-center">
                  <p className="text-3xl font-black text-[#0b1b3d]">10</p>
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider font-bold mt-0.5">Provinsi</p>
                </div>
                <div className="w-px h-10 bg-slate-200" />
                <div className="text-center">
                  <p className="text-3xl font-black text-[#0b1b3d]">1</p>
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider font-bold mt-0.5">Kantor Pusat</p>
                </div>
                <div className="w-px h-10 bg-slate-200" />
                <div className="text-center">
                  <p className="text-sm font-black text-[#0b1b3d]">Sumatera</p>
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider font-bold mt-0.5">Regional</p>
                </div>
              </div>
            </div>
          </div>
