...
export default function IctIndikatorPage() {
  ...
  return (
    <div className="bg-white">
      {/* Banner Header */}
      <PageHeader
        title="ICT Indikator & Survei TIK"
        subtitle="Data statistik resmi, indeks literasi digital, dan laporan pemetaan infrastruktur teknologi komunikasi di wilayah Provinsi Sumatera Utara dan sekitarnya."
        breadcrumbs={[
          { label: "Beranda", href: "/" },
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto shrink-0 justify-end">
              <span className="text-xs font-bold text-[#64748b] uppercase">Kategori:</span>
              <select
