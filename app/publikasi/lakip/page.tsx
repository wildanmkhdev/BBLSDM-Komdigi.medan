          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="flex items-center gap-2 w-full md:w-auto shrink-0 justify-end">
                <span className="text-xs font-bold text-slate-500 uppercase">Tahun Kinerja:</span>
                <select
                  value={selectedYear}
            ...
            {filteredDocs.length > 0 ? (
              ...
              <div className="text-center py-16 bg-white rounded-xl border border-slate-200 shadow-sm">
                <svg
                  className="mx-auto h-12 w-12 text-slate-300 mb-4 animate-pulse"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="1.5"
                ...
                <p className="text-xs text-slate-500 mt-1">Coba gunakan kata kunci atau filter tahun lainnya.</p>
              </div>
            )}
          </div>
        </section>
