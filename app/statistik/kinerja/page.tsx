                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <h3 className="text-xs font-bold text-[#0b1b3d] leading-snug line-clamp-2">
                        {m.name}
                      </h3>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-10 space-y-8 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  <h2 className="text-xl font-extrabold text-[#0b1b3d] mt-1">
                    {activeMetric.name}
                  </h2>
                </div>
                ...
                <div className="flex items-center gap-3 bg-slate-50 p-3 rounded-xl border border-slate-200">
                  <div className="text-right">
                    <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                      Capaian Target Total
                    </span>
                    <span className="text-lg font-black text-[#0284c7]">
                      {achievementPercentage}%
                    </span>
                  </div>
                  <div className="w-10 h-10 rounded-full bg-[#0b1b3d] text-[#fbbf24] flex items-center justify-center font-black text-xs shadow">
                    ✓
                  </div>
                </div>
              </div>
              ...
              {/* Bar Chart Interactive Render */}
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-extrabold uppercase tracking-widest text-[#0b1b3d]">
                    Pertumbuhan Nilai dari Tahun ke Tahun
                  </span>
                  <span className="text-xs text-slate-400">
                    Satuan: {activeMetric.unit}
                  </span>
                </div>
              ...
              <div className="p-4 bg-sky-50/60 rounded-xl border border-sky-100 flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-[#0284c7] text-white flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                  i
                </div>
