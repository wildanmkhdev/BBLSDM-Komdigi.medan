      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#0a2540] via-[#0f345c] to-[#0a2540] py-16 px-6 text-white shadow-md">
        ...
        <div className="max-w-6xl mx-auto space-y-4">
          <div className="flex items-center gap-2 text-xs font-semibold text-sky-400">
            <span>Statistik</span>
            <span>/</span>
            <span className="text-gray-300">Kinerja</span>
          </div>
      ...
      <section className="max-w-6xl mx-auto py-12 px-6 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white dark:bg-zinc-900 p-4 rounded-xl border border-gray-100 dark:border-zinc-800 shadow-sm">
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold text-gray-800 dark:text-white">Pilih Tahun Evaluasi:</span>
          ...
          <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-wider text-gray-500">
            <div className="flex items-center gap-1.5">
              <span className="h-3 w-3 rounded-sm bg-gray-300 dark:bg-zinc-700" />
              <span>Target</span>
            </div>
            <div className="flex items-center gap-1.5">
                  ...
                  return (
                    <g key={i} className="opacity-40">
                      ...
                      <text
                        ...
                        y={y + 4}
                        textAnchor="end"
                        className="text-[10px] font-semibold fill-gray-500 dark:fill-zinc-400"
                      >
                        {val}
                      </text>
                    </g>
                  ...
                  return (
                    ...
                    >
                      ...
                      <rect
                        ...
                        rx="4"
                        className="transition-all duration-300 dark:fill-zinc-700 dark:hover:fill-zinc-600"
                      />
                      ...
                      <text
                        ...
                        y={chartHeight + 20}
                        textAnchor="middle"
                        className="text-[9px] font-bold fill-gray-600 dark:fill-zinc-400"
                      >
                        {`Indikator ${idx + 1}`}
                      </text>
                ...
                >
                  ...
                  <div className="mt-4 flex items-end justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-[10px] text-gray-500 dark:text-zinc-400">Target</p>
