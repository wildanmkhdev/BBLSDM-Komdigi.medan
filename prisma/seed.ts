  ...
  const aplikasiList = [
    {
      ...
      description: "Aplikasi internal untuk mengelola persediaan barang masuk, barang keluar, inventarisasi aset IT, dan pelaporan stok gudang.",
    ...
    },
    {
      ...
      description: "Aplikasi portal khusus untuk pencatatan kehadiran pegawai, pengajuan cuti online, manajemen data kinerja, serta rekapitulasi data ASN.",
      url: "https://simpeg.bblsdm.go.id",
      logoId: dbMedia[1].id,
    },
    {
      name: "E-Office & Surat Menyurat",
      slug: "e-office-surat-menyurat",
      description: "Layanan persuratan dinas elektronik, disposisi online, dan pelacakan surat keluar masuk di lingkungan BBLSDM.",
      url: "https://eoffice.bblsdm.go.id",
      logoId: dbMedia[2].id,
    },
    {
      name: "Portal Pengajuan Magang",
      slug: "portal-pengajuan-magang",
      description: "Sistem pendaftaran dan pelacakan status program magang bagi siswa dan mahasiswa secara online.",
      url: "https://magang.bblsdm.go.id",
      logoId: dbMedia[0].id,
    },
    {
      name: "Katalog Pelatihan TIK",
      slug: "katalog-pelatihan-tik",
      description: "Katalog program pelatihan bidang teknologi informasi dan komunikasi yang diselenggarakan oleh BBLSDM.",
      url: "https://pelatihan.bblsdm.go.id",
      logoId: dbMedia[1].id,
    },
    {
      name: "Sistem Monitoring Jaringan",
      slug: "sistem-monitoring-jaringan",
      description: "Aplikasi pemantauan status server, bandwidth internet balai, dan status konektivitas jaringan kantor cabang.",
      url: "https://noc.bblsdm.go.id",
      logoId: dbMedia[2].id,
    },
    {
      name: "Perpustakaan Digital Balai",
      slug: "perpustakaan-digital-balai",
      description: "Katalog e-book, jurnal penelitian TIK, laporan kearsipan, dan literatur digital resmi milik BBLSDM.",
      url: "https://elibrary.bblsdm.go.id",
      logoId: dbMedia[0].id,
    },
    {
      name: "Dashboard Statistik Kinerja",
      slug: "dashboard-statistik-kinerja",
      description: "Visualisasi data capaian kinerja instansi, realisasi anggaran, dan infografis statistik pelatihan berkala.",
      url: "https://dashboard.bblsdm.go.id",
      logoId: dbMedia[1].id,
    },
    {
      name: "Sistem Pengaduan Masyarakat (DUMAS)",
      slug: "sistem-pengaduan-masyarakat-dumas",
      description: "Layanan pelaporan aduan masyarakat terkait pelayanan publik dan pelanggaran disiplin kerja di lingkungan balai.",
      url: "https://dumas.bblsdm.go.id",
      logoId: dbMedia[2].id,
    },
    {
      name: "Layanan Feedback Komentar",
      slug: "layanan-feedback-komentar",
      description: "Saluran penampung masukan, keluhan pengguna, saran kebersihan/fasilitas kantor, dan survei kepuasan pengunjung.",
      url: "https://feedback.bblsdm.go.id",
      logoId: dbMedia[0].id,
    },
  ];
